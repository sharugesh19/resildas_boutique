...
// Centralized icon set — keeps stroke-width/sizing consistent site-wide.
// Reuse these instead of adding one-off emoji or text symbols to new components.
...
// Same path already used in ProductCard.jsx — centralized so Wishlist.jsx
// (and anywhere else) can reuse the identical heart shape instead of a ♡ glyph.
...
export function ImagePlaceholderIcon({ size = 32 }) {
  return (
...
export function XCircleIcon({ size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function RulerIcon({ size = 14 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 12h20M6 12V9M10 12V8M14 12V9M18 12V8"/>
      <rect x="2" y="6" width="20" height="12" rx="1"/>
    </svg>
  );
}

export function BagIcon({ size = 16 }) {
  return (
...
export function ExchangeIcon({ size = 20 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
