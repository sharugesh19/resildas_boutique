...
function ContactSection() {
  ...
  return (
    <section className="contact-premium" id="contact">
      <div className="container contact-premium__inner">
        {/* Left: Info */}
        <div className="contact-premium__info">
          <span className="eyebrow">Say Hello</span>
          <h2 className="section-title">Get in Touch</h2>
          <p className="contact-premium__desc">
            Whether it's a custom order, a question about sizing, or just a chat about ethnic fashion — we're here for you.
          </p>

          <div className="contact-premium__items">
            ...
            <div className="contact-item">
              ...
              <div>
                <p className="contact-item__label">Store Hours</p>
                <p className="contact-item__val">Mon–Sat, 10am – 7pm</p>
              </div>
            </div>
        ...
        {/* Right: Form */}
        <div className="contact-premium__form-wrap">
          {sent ? (
